...
class Player(arcade.Sprite):
    ...
    def __init__(self):
        ...
        self.texture_left = arcade.load_texture("santa.png", mirrored=True, scale=player_scaling)
        self.texture_right = arcade.load_texture("santa.png", scale=player_scaling)
